...
namespace Core.Entities
{
    public class Product : BaseEntity
    {
       ...
       // Чтобы исключить возможность загрузки изображения в фотоколлекцию другого товара
        // мы сделаем этот список доступным только для чтения и предоставим в классе методы для добавления новой фотографии.
        // Вот новый класс Product.cs
